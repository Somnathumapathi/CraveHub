    ...
    const MerchantRegister = () => {
        ...
        e.preventDefault();
        if(passKey == process.env.NEXT_PUBLIC_PASS_KEY) {
            try {
        ...
        return (
            ...
            <div className="absolute inset-1 bg-gray-800 rounded-lg z-10 p-5 relative w-[380px] h-[420px]">
                ...
                <InfoToolTip content="Pass key will be given by owner when you join. Please do not share it with anyone else." />
              ...
              <br/><br/>
                <div className="relative flex flex-col mb-6">
                    ...
                    <label className="peer-focus:font-medium absolute text-sm duration-300 transform -translate-y-8 scale-75 top-3 left-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-green-500 text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-gray-500 peer-focus:scale-75 peer-focus:-translate-y-8">*Enter PassKey</label>
                ...
                Already have an account?{' '}     
                    <Link href='/merchantLogin' className="text-green-500">Login</Link>
                </p>
            </div>
