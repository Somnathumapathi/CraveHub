...
<h1 class="text-2xl lg:text-3xl text-green-600 font-bold font-sans leading-loose text-4xl transform transition-transform hover:text-green-500 hover:scale-105 duration-300 mb-4">
    My Items:</h1>
    
{merchantItems.map((item) => (
    <div key={item.id}>
        <p class="text-lg lg:font-semibold text-gray-400 leading-loose hover:scale-105 hover:text-white duration-200">{item.name}</p>
    </div>
))}
</div>
    )
